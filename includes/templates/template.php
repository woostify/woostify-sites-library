...
<script type="text/template" id="tmpl-ast-template-base-skeleton">
	<div class="dialog-widget dialog-lightbox-widget dialog-type-buttons dialog-type-lightbox" id="ast-sites-modal">
		<div class="dialog-widget-content dialog-lightbox-widget-content">
			<div class="woostify-site-content-wrap" data-page="1">
					...
					<div class="elementor-template-library-filter-toolbar">
						<div class="elementor-template-library-order">
							<select class="elementor-template-library-order-input elementor-template-library-filter-select elementor-select2">
								<option value=""><?php esc_html_e( 'All', 'woostify-site' ); ?></option>
								<option value="free"><?php esc_html_e( 'Free', 'woostify-site' ); ?></option>
								<option value="agency"><?php esc_html_e( 'Agency', 'woostify-site' ); ?></option>
							</select>
						</div>
						...
						<div class="astra-blocks-filter-inner-wrap">
							<select id="elementor-template-library-filter" class="astra-blocks-filter elementor-template-library-filter-select elementor-select2">
								<option value=""><?php esc_html_e( 'Filter by Color', 'woostify-site' ); ?></option>
								<option value="light"><?php esc_html_e( 'Light', 'woostify-site' ); ?></option>
								<option value="dark"><?php esc_html_e( 'Dark', 'woostify-site' ); ?></option>
							</select>
						</div>
					</div>
					<div class="ast-sites-template-library-filter-text-wrapper">
						<label for="elementor-template-library-filter-text" class="elementor-screen-only"><?php esc_html_e( 'Search...', 'woostify-site' ); ?></label>
						<input id="wp-filter-search-input" placeholder="<?php esc_html_e( 'SEARCH', 'woostify-site' ); ?>" class="">
				...
				<?php
				$manual_sync = get_site_option( 'woostify-site-manual-sync-complete', 'no' );
				if ( 'yes' === $manual_sync ) {
					$batch_status = get_site_option( 'woostify-site-batch-is-complete', 'no' );
					if ( 'yes' === $batch_status ) {
						?>
						<div class="ast-sites-floating-notice-wrap refreshed-notice slide-in">
							<div class="ast-sites-floating-notice">
								<div class="woostify-site-sync-library-message success woostify-site-notice notice notice-success is-dismissible">
									<?php Astra_Sites::get_instance()->get_sync_complete_message( true ); ?> <button type="button" class="notice-dismiss"><span class="screen-reader-text"><?php esc_html_e( 'Dismiss', 'woostify-site' ); ?></span></button>
								</div>
							</div>
						</div>
						<?php
...
<script type="text/template" id="tmpl-ast-template-modal__header-back">
	<div class="dialog-lightbox-back"><span class="dialog-lightbox-back-text"><?php esc_html_e( 'Back to Pages', 'woostify-site' ); ?></span></div>
</script>
	...
	<div class="dialog-header dialog-lightbox-header">
		<div class="ast-sites-modal__header">
			<div class="ast-sites-modal__header__logo-area">
				...
				?>
				<div class="back-to-layout" title="<?php esc_html_e( 'Back to Layout', 'woostify-site' ); ?>" data-step="1"><i class="ast-icon-chevron-left"></i></div>
			</div>
			<div class="elementor-templates-modal__header__menu-area woostify-site-step-1-wrap ast-sites-modal__options">
				<div class="elementor-template-library-header-menu">
					<div class="elementor-template-library-menu-item elementor-active" data-template-source="remote" data-template-type="pages"><span class="ast-icon-file"></span><?php esc_html_e( 'Pages', 'woostify-site' ); ?></div>		
					<div class="elementor-template-library-menu-item" data-template-source="remote" data-template-type="blocks"><span class="ast-icon-layers"></span><?php esc_html_e( 'Blocks', 'woostify-site' ); ?></div>
				</div>
			</div>
			<div class="elementor-templates-modal__header__items-area">
				<div class="ast-sites-modal__header__close ast-sites-modal__header__close--normal ast-sites-modal__header__item">
					<i class="dashicons close dashicons-no-alt" aria-hidden="true" title="<?php esc_html_e( 'Close', 'woostify-site' ); ?>"></i>
					<span class="elementor-screen-only"><?php esc_html_e( 'Close', 'woostify-site' ); ?></span>
				</div>
				<div class="woostify-site__sync-wrap">
					<div class="woostify-site-sync-library-button">
						<span class="ast-icon-refresh" aria-hidden="true" title="<?php esc_html_e( 'Sync Library', 'woostify-site' ); ?>"></span>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/template" id="tmpl-woostify-site-list">

	<#
		var count = 0;
		for ( key in data ) {
			var page_data = data[ key ][ 'pages' ];
			var site_type = data[ key ][ 'woostify-site-type' ] || '';
			...
			var type_class = ' site-type-' + data[ key ]['woostify-site-type'];
			...
			<div class="theme astra-theme site-single publish page-builder-elementor {{type_class}}" data-site-id={{key}} data-template-id="">
				<div class="inner">
					...
					<# if ( site_type && 'free' !== site_type ) { #>
						...
						<div class="agency-ribbons" title="<?php printf( esc_attr__( 'This premium template is accessible with %1$s "Agency" Package.', 'woostify-site' ), Astra_Sites_White_Label::get_instance()->get_white_label_name() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?php esc_html_e( 'Agency', 'woostify-site' ); ?></div>
					<# } #>
				</div>
			</div>
	<#
...
<script type="text/template" id="tmpl-astra-blocks-list">
	...
	<#
		...
		for ( key in data ) {
			...
			count++;
	#>
		<div class="woostify-site-library-template astra-theme" data-block-id={{key}}>
			<div class="woostify-site-library-template-inner" >
				...
				<div class="elementor-template-library-template-footer">
					...
					<a class="elementor-template-library-template-action elementor-template-library-template-insert ast-block-insert">
						...
						<span class="elementor-button-title"><?php esc_html_e( 'INSERT', 'woostify-site' ); ?></span>
					</a>
				</div>
			</div>
		</div>
	<#
		...
		if ( count == 0 ) {
	#>
		<div class="woostify-site-no-sites">
			<div class="inner">
				<h3><?php esc_html_e( 'Sorry No Results Found.', 'woostify-site' ); ?></h3>
				<div class="content">
					<div class="description">
						...
						printf( __( 'Don\'t see a template you would like to import?<br><a target="_blank" href="%1$s">Make a Template Suggestion!</a>', 'woostify-site' ), esc_url( $s_url ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						?>
						</p>
						<div class="back-to-layout-button"><span class="button woostify-site-back"><?php esc_html_e( 'Back to Templates', 'woostify-site' ); ?></span></div>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/template" id="tmpl-woostify-site-list-search">
				...
				<div class="theme-id-container">
					...
					<# } else { #>
						<a class="elementor-template-library-template-action elementor-template-library-template-go-pro" href="{{astraElementorSites.getProURL}}" target="_blank">
							...
							<span class="elementor-button-title"><?php esc_html_e( 'Get Access!', 'woostify-site' ); ?></span>
						</a>
					<# } #>
				</div>
				<# if ( site_type && 'free' !== site_type ) { #>
...
<script type="text/template" id="tmpl-woostify-site-search">
	...
	<#
		...
		for ( ind in data ) {
			...
			if ( 'site' == data[ind]['type'] ) {
				site_type = data[ ind ]['woostify-site-type'];
			}
...
<script type="text/template" id="tmpl-woostify-site-insert-button">
 ...
 */
?>
<script type="text/template" id="tmpl-woostify-site-third-party-required-plugins">
	<div class="skip-and-import">
		<div class="heading">
			<h3><?php esc_html_e( 'Required Plugins Missing', 'woostify-site' ); ?></h3>
			<span class="dashicons close dashicons-no-alt"></span>
		</div>
		<div class="woostify-site-import-content">
			<p><?php esc_html_e( 'This starter site requires premium plugins. As these are third party premium plugins, you\'ll need to purchase, install and activate them first.', 'woostify-site' ); ?></p>
			<ul class="woostify-site-third-party-required-plugins">
				<# for ( key in data ) { #>
		...
		<div class="ast-actioms-wrap">
			<a href="#" class="button button-hero button-primary woostify-site-skip-and-import-step"><?php esc_html_e( 'Skip & Import', 'woostify-site' ); ?></a>
			<div class="button button-hero site-import-cancel"><?php esc_html_e( 'Cancel', 'woostify-site' ); ?></div>
		</div>
	</div>
</script>

<script type="text/template" id="tmpl-woostify-site-no-sites">
	<div class="woostify-site-no-sites">
		<div class="inner">
			<h3><?php esc_html_e( 'Sorry No Results Found.', 'woostify-site' ); ?></h3>
			<div class="content">
...
<script type="text/template" id="tmpl-woostify-site-elementor-preview">
	<#
	let wrap_height = $elscope.find( '.woostify-site-content-wrap' ).height();
...
<script type="text/template" id="tmpl-woostify-site-elementor-preview-actions">
	<#
	var demo_link = '';
	var action_str = '';
		...
		<div class="astra-preview-actions-inner-wrap">
			<div class="astra-preview-actions">
				<div class="site-action-buttons-wrap">
					<div class="woostify-site-import-template-action site-action-buttons-right">
						<div class="woostify-site-tooltip"><span class="woostify-site-tooltip-icon" data-tip-id="woostify-site-tooltip-plugins-settings"><span class="dashicons dashicons-editor-help"></span></span></div>
						<#
						var is_free = true;
						if ( 'pages' == AstraElementorSitesAdmin.type ) {
						...
						<# } else { #>
							<div type="button" class="button button-hero button-primary ast-library-template-insert disabled"><?php esc_html_e( 'Import ', 'woostify-site' ); ?>{{action_str}}</div>
							<div type="button" class="button button-hero button-primary ast-import-elementor-template disabled"><?php esc_html_e( 'Save ', 'woostify-site' ); ?>{{action_str}}</div>
						<# } #>
					</div>
				</div>
			</div>
			<div class="ast-tooltip-wrap">
				<div>
					<div class="ast-tooltip-inner-wrap" id="woostify-site-tooltip-plugins-settings">
