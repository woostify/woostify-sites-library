...
= 1.5.9 =
* Fix warning load_textdomain_just_in_time
* Fix the warning on the plugin

= 1.5.8 =
* Fix demos not showing error

= 1.5.7 =
* Add Fishing Demo

= 1.5.6 =
* Fix the error install the plugin before importing demo.
* Remove the icon warning before importing demo.
...
= 1.4.8 =
* Change current_user_can function
